...
class SplashLoadingAnimation extends StatefulWidget {
  ...
  @override
  State<SplashLoadingAnimation> createState() => _SplashLoadingAnimationState();
}

class _SplashLoadingAnimationState extends State<SplashLoadingAnimation>
